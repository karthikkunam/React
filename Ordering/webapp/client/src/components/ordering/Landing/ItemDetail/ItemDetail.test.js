...
beforeEach(()=>{
    wrapped = shallow(
                <ItemDetail store={ store } dispatch = { random } storeSelectedData =  { initialState.stores.storeProfileDetails[0] } SingleDayCategories= {categoryData.singleDay.category[0]}/>
              );
...
describe('Ordering ItemDetail Component', () => {
  it('render ItemDetail functions', () => {
      const instance = wrapped.instance();
      instance.expandPanel ('',0);
  })
});
