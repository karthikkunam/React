...
beforeEach(()=>{
    wrapped = shallow(
                <OrderingDetail store={ store } dispatch = { random } storeSelectedData =  { initialState.stores.storeProfileDetails[0] }  />
              );
...
describe('Ordering OrderingDetail Component', () => {
  it('render OrderingDetail functions', () => {
